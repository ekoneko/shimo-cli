...
export const FileTypeMap: {
  ...
  "0": { id: 0, name: "文档", url: "doc", stringType: "doc" },
  ...
  "-1": { id: -1, name: "表格", url: "spreadsheet", stringType: "sheet" },
  "-2": { id: -2, name: "文档", url: "docs", stringType: "doc" },
  "-3": { id: -3, name: "表格", url: "sheet", stringType: "sheet" },
  "-4": { id: -4, name: "表格", url: "sheets", stringType: "sheet" },
  "-5": { id: -5, name: "幻灯片", url: "slides", stringType: "slide" },
  "-6": { id: -6, name: "文档", url: "docx", stringType: "doc" },
